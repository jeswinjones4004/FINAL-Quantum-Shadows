...
import { Shield, Lock, AlertTriangle, CheckCircle, Smartphone, Server, FileCode, Terminal, ChevronDown, Check, X, ArrowRight, Activity, Zap, Info } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <Card className="h-full">
              ...
              <div className="space-y-4 max-h-[220px] overflow-y-auto pr-2 custom-scrollbar text-xs font-mono text-slate-400">
                ...
                <div className="flex gap-3 items-start animate-fade-in delay-150">
                  <span className="text-slate-600 shrink-0">21:23:15</span>
                  <span className="text-green-400 font-bold w-16 shrink-0">SUCCESS</span>
                  <span>Automated PQC migration patch successfully applied to Kubernetes Cluster A.</span>
                </div>
                <div className="flex gap-3 items-start opacity-70">
                  <span className="text-slate-600 shrink-0">21:22:50</span>
                  <span className="text-blue-400 font-bold w-16 shrink-0">INFO</span>
                  <span>Daily key rotation scheduled for 03:00 UTC.</span>
                </div>
              </div>
            </Card>
